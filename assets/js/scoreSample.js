...
$.getJSON(dataSourceUrl,function(data) {
    $.each(data, function(i, item) {
        $('<tr>').addClass(item.region).append(
            $('<td>').css({"height" :"30px", "color":"black","font-weight":"bold","text-transform": "capitalize","font-size": "7.5px","font-family": "Roboto, Helvetica, Arial, sans-serif"}).text(item.country),
